...
public class VentePouleEditDialogController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        quantitéSpinner.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 10000, ventePoule.getQuantité()));
        
        prixUnitaireSpinner.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(50, 10000, ventePoule.getPrixUnitaire()));
    ...
    public void setVentePoule(VentePoule ventePoule) {
        ...
        quantitéSpinner.getValueFactory().setValue(ventePoule.getQuantité());
        prixUnitaireSpinner.getValueFactory().setValue(ventePoule.getPrixUnitaire());
        prixTotalTextField.setText(ventePoule.getPrixTotal()+"");
    }
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            ventePoule.setQuantité(quantitéSpinner.getValue());
            ventePoule.setPrixUnitaire(prixUnitaireSpinner.getValue());
