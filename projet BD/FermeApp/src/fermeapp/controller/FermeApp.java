    ...
    public void initEntree(){
     ...
     public void initSoins(){
        ...
        try {
            ...
            System.out.println("soins controller " + S);
            S.setFermeApp(this);
            this.setSoins(S);
            this.getPrimaryStage().setScene(new Scene(root));
            this.getPrimaryStage().show();
...
//            this.getStage().show();;
    ...
    public void leftMenuShow(){
        FXMLLoader loader = new FXMLLoader();
        try{
            loader.setLocation(getClass().getResource("/fermeapp/view/leftMenuView.fxml"));
            this.getLeafLeft().getChildren().clear();
            this.getLeafLeft().getChildren().add((AnchorPane)loader.load());
            ((LeftMenuViewController)loader.getController()).setFermeApp(this);
        }
        catch(IOException e){
            e.printStackTrace();
        }
    ...
    public void soinsShow(){
        ...
        try{
            ...
            this.getLeafRigth().getChildren().clear();
            this.getLeafRigth().getChildren().add((AnchorPane)loader.load());
            Soins_viewController soin = loader.getController();
            soin.setFermeApp(this);
            this.setSoins(soins);
        }
        catch(IOException e){
            e.printStackTrace();
    ...
    public void ModifierPUView(){
        // Fenetre pour modifier les prix unitaires
    }
    
    public void produireFacture(){
        // Produire la facture en utilisant l'objet : VenteviewController.factureFinale
        System.out.println(VenteviewController.factureFinale);
    }
}
