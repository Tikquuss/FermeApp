...
public class Vente {
    ...
    private ObjectProperty<Partenaire> partenaire;

    public  ObjectProperty<Partenaire> partenaireProperty() {
        return partenaire;
    }

    public void setPartenaire(ObjectProperty<Partenaire> partenaire) {
        this.partenaire = partenaire;
    }
    
    
    public void setPartenaire(Partenaire p){
        this.partenaire.set(p);
    }
