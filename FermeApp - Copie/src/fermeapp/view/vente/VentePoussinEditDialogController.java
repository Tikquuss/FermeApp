...
import static fermeapp.view.vente.VentePouleEditDialogController.ventePoule;
import java.net.URL;
...
public class VentePoussinEditDialogController implements Initializable {
    ...
    private void handleOk() {
        ...
        ventePoussin.setQuantité(Integer.parseInt(quantitéSpinner.getEditor().getText()));
        ventePoussin.setPrixUnitaire(Integer.parseInt(prixUnitaireSpinner.getEditor().getText()));
