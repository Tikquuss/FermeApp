...
// Les écouteurs
    ...
    private void handleAjouter() {
        VentePoussinData.add(new VentePoussin(ageCombo.getValue(), quantitéSpinner.getValue(), prixUnitaireSpinner.getValue()));
    ...
    private void handleModifier() {
       VentePoussin vo  = factureTableView.getSelectionModel().getSelectedItem();
       if (vo != null) {
