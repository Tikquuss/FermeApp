...
// Les écouteurs
    ...
    private void handleAjouter() {
        VentePouleData.add(new VentePoule(typeCombo.getValue(), quantitéSpinner.getValue(), prixUnitaireSpinner.getValue()));
    ...
    private void handleModifier() {
       VentePoule vo  = factureTableView.getSelectionModel().getSelectedItem();
       if (vo != null) {
